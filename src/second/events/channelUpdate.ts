...
export default class ChannelUpdateEvenet extends BotEvent {
  constructor() {
    super('channelUpdate')
  }

  async execute(oldChannel: DMChannel | NonThreadGuildBasedChannel, newChannel: DMChannel | NonThreadGuildBasedChannel, client: SecondClientData) {
