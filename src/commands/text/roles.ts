import { EmbedBuilder, ActionRowBuilder, SelectMenuBuilder, Message, Client } from "discord.js";

export const rolesCommand = (msg: Message, client: Client) => {
  const color = msg.guild?.members.me?.displayHexColor || 'White'
  const embGenero = new EmbedBuilder()
  ...
  const menuGenero = new ActionRowBuilder<SelectMenuBuilder>()
  .addComponents(
    [
  ...
  const embEdad = new EmbedBuilder()
  ...
  const menuEdad = new ActionRowBuilder<SelectMenuBuilder>()
  .addComponents(
    new SelectMenuBuilder()
    .setCustomId("edad")
    .setPlaceholder("📑 Elige una opción para obtener un rol.")
  ...
  const embVideojuegos = new EmbedBuilder()
  ...
  const menuVideojuegos = new ActionRowBuilder<SelectMenuBuilder>()
  .addComponents(
    new SelectMenuBuilder()
  ...
  const embColores = new EmbedBuilder()
  ...
  const menuColores = new ActionRowBuilder<SelectMenuBuilder>()
  .addComponents(
    new SelectMenuBuilder()
    .setCustomId("colores")
    .setPlaceholder("📑 Elige una opción para obtener un rol.")
  ...
  const embNotificaciones = new EmbedBuilder()
  ...
  const menuNotificaciones = new ActionRowBuilder<SelectMenuBuilder>()
  .addComponents(
    new SelectMenuBuilder()
