...
const setGuildStatus = (client) => {
    ...
    const allMembers = snackServer === null || snackServer === void 0 ? void 0 : snackServer.memberCount, nsfwChannels = snackServer === null || snackServer === void 0 ? void 0 : snackServer.channels.cache.filter(f => f.parentId == '1028795913788993547').size;
    const onlineChanel = snackServer === null || snackServer === void 0 ? void 0 : snackServer.channels.cache.get('1048643827084308551');
    const membersChanel = snackServer === null || snackServer === void 0 ? void 0 : snackServer.channels.cache.get('1048643787431346316');
    const nsfwChanel = snackServer === null || snackServer === void 0 ? void 0 : snackServer.channels.cache.get('1048645170238861402');
