...
exports.interactionEvent = exports.interactionCommands = void 0;
...
(0, fs_1.readdirSync)(`./${isDist}/first/commands/slash/`).forEach(async (folder) => {
    (0, fs_1.readdirSync)(`./${isDist}/first/commands/slash/${folder}/`).forEach(async (file) => {
        // console.log(file)
...
// readdirSync(`./${isDist}/first/commands/context/`).forEach(async folder=> {
//   readdirSync(`./${isDist}/first/commands/context/${folder}/`).forEach(async file=> {
//     console.log({file})
