...
const crearSlashCommand = (int, client) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (subCommand == "alianza") {
        const dataAli = yield models_1.alliancesModel.findById(serverId), arrayMi = dataAli === null || dataAli === void 0 ? void 0 : dataAli.members, arraySv = dataAli === null || dataAli === void 0 ? void 0 : dataAli.servers;
        ...
        const colector = (_b = int.channel) === null || _b === void 0 ? void 0 : _b.createMessageCollector({ filter: u => u.author.id == int.user.id, time: 30000, max: 1 });
            ...
            function alianzaSystem(des1, des2, des3, contenido) {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (arrayMi === null || arrayMi === void 0 ? void 0 : arrayMi.some(s => s.id == int.user.id)) {
                        ...
                        arrayMi === null || arrayMi === void 0 ? void 0 : arrayMi.push({ tag: int.user.tag, id: int.user.id, amount: 1 });
                    }
            ...
            if (m) {
                ...
                client.fetchInvite(plantilla.split(/ +/g).find(f => ["discord.com/invite/", "discord.gg/"].some(s => f.includes(s))) || '').then((invite) => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    if (arraySv === null || arraySv === void 0 ? void 0 : arraySv.some(s => { var _a; return s.id == ((_a = invite.guild) === null || _a === void 0 ? void 0 : _a.id); })) {
                        ...
                        if (servidor) {
                            if (servidor.time >= Math.floor(Date.now() - (0, ms_1.default)("7d")))
                                return int.editReply({ embeds: [
                                        (0, functions_1.createEmbedMessage)(`${emoji.negative} Error`, `Ya se ha echo alianza con ese servidor y esa alianza se ha echo **<t:${Math.floor(((servidor === null || servidor === void 0 ? void 0 : servidor.time) || 0) / 1000)}:R>** así que no se puede renovar por ahora.`, color.negative)
                                    ] });
                            servidor.name = ((_g = invite.guild) === null || _g === void 0 ? void 0 : _g.name) || '';
                        ...
                        arraySv === null || arraySv === void 0 ? void 0 : arraySv.push({ name: ((_h = invite.guild) === null || _h === void 0 ? void 0 : _h.name) || '', id: ((_j = invite.guild) === null || _j === void 0 ? void 0 : _j.id) || '', time: Date.now(), invitation: invite.url, members: invite.memberCount });
                    }
    ...
    if (subCommand == "encuesta") {
        ...
        const colorEb = (_c = guild === null || guild === void 0 ? void 0 : guild.roles.cache.get((dataEnc === null || dataEnc === void 0 ? void 0 : dataEnc.data.rolId) || '')) === null || _c === void 0 ? void 0 : _c.hexColor;
        const title = int.options.getString("titulo", true), tiempo = int.options.getString("tiempo", true), description = int.options.getString("descripción") || undefined, canal = (guild === null || guild === void 0 ? void 0 : guild.channels.cache.get(((_d = options.getChannel("canal")) === null || _d === void 0 ? void 0 : _d.id) || '')) || int.channel, opcion1 = options.getString("opción1"), opcion2 = options.getString("opción2"), opcion3 = options.getString("opción3"), opcion4 = options.getString("opción4"), opcion5 = options.getString("opción5"), opcion6 = options.getString("opción6");
        let cantidadOpciones = 0, posicion = 0, opciones = [];
        [opcion1, opcion2, opcion3, opcion4, opcion5, opcion6].forEach(option => {
            if (option) {
                cantidadOpciones++;
                opciones.push({ emoji: (dataEnc === null || dataEnc === void 0 ? void 0 : dataEnc.data.emojis[posicion]) || '', option: option, votes: 0 });
                posicion++;
            }
        });
        if ((0, functions_1.setSlashErrors)(int, [
        ...
        if (canal && (canal.type == discord_js_1.ChannelType.GuildText || canal.type == discord_js_1.ChannelType.GuildAnnouncement)) {
            canal.send({ embeds: [embEncuesta], content: `**¡Nueva encuesta <@&${dataEnc === null || dataEnc === void 0 ? void 0 : dataEnc.data.rolId}>!**` }).then((ts) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                arrayEn === null || arrayEn === void 0 ? void 0 : arrayEn.push({ id: ts.id, channelId: canal.id, ends: Math.floor(Date.now() + (0, ms_1.default)(tiempo)), authorId: int.user.id, createdAt: Date.now(), active: true, options: opciones });
                yield models_1.surveysModel.findByIdAndUpdate(serverId, { encuestas: arrayEn });
            }));
        }
    }
    if (subCommand == "sorteo") {
        let dataSor = yield models_1.rafflesModel.findById(serverId), arraySo = dataSor === null || dataSor === void 0 ? void 0 : dataSor.raffles, colorEb = (_e = guild === null || guild === void 0 ? void 0 : guild.roles.cache.get((dataSor === null || dataSor === void 0 ? void 0 : dataSor.data.rolId) || '')) === null || _e === void 0 ? void 0 : _e.hexColor;
        const title = options.getString("titulo", true), tiempo = options.getString("tiempo", true), preGanadores = options.getInteger("ganadores"), ganadores = preGanadores ? Math.floor(preGanadores) : null, description = options.getString("descripción") || undefined, canal = (guild === null || guild === void 0 ? void 0 : guild.channels.cache.get(((_f = options.getChannel("canal")) === null || _f === void 0 ? void 0 : _f.id) || '')) || int.channel;
        if ((0, functions_1.setSlashErrors)(int, [
            [
                Boolean(!(author === null || author === void 0 ? void 0 : author.permissions.has('Administrator'))),
                `¡No eres administrador del servidor!, no puede utilizar el comando.`
        ...
        const embEnviado = new discord_js_1.EmbedBuilder()
            ...
            .setColor(color.afirmative);
        if (canal && (canal.type == discord_js_1.ChannelType.GuildText || canal.type == discord_js_1.ChannelType.GuildAnnouncement)) {
            canal.send({ embeds: [embSorteo], content: `**¡Nuevo sorteo <@&${dataSor === null || dataSor === void 0 ? void 0 : dataSor.data.rolId}>**!` }).then((ts) => __awaiter(void 0, void 0, void 0, function* () {
                if (canal.id != int.channelId)
                    embEnviado.setDescription(`El sorteo ha sido creado en el canal ${canal}.`);
                ts.react("974801702307901490");
                int.reply({ ephemeral: true, embeds: [embEnviado] });
                arraySo === null || arraySo === void 0 ? void 0 : arraySo.push({ id: ts.id, channelId: canal.id, ends: Math.floor(Date.now() + (0, ms_1.default)(tiempo)), winners: ganadores || 1, authorId: int.user.id, createdAt: Date.now(), active: true, participants: [] });
