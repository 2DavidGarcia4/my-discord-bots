...
const rerollSlashCommand = (int) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dataSor = yield models_1.rafflesModel.findById(serverId), arraySo = dataSor === null || dataSor === void 0 ? void 0 : dataSor.raffles, messageId = options.getString("id", true);
    if ((0, functions_1.setSlashErrors)(int, [
        ...
        return;
    const raffle = arraySo === null || arraySo === void 0 ? void 0 : arraySo.find(f => f.id == messageId), channel = guild === null || guild === void 0 ? void 0 : guild.channels.cache.get((raffle === null || raffle === void 0 ? void 0 : raffle.channelId) || ''), message = ((channel === null || channel === void 0 ? void 0 : channel.type) == discord_js_1.ChannelType.GuildText || (channel === null || channel === void 0 ? void 0 : channel.type) == discord_js_1.ChannelType.GuildAnnouncement) ? channel.messages.cache.get(messageId) : undefined;
    const participants = raffle === null || raffle === void 0 ? void 0 : raffle.participants.filter(f => guild === null || guild === void 0 ? void 0 : guild.members.cache.has(f));
    ...
    if (raffle && participants) {
        for (let r = 0; r < bueltas; r++) {
            ...
            if ((raffle === null || raffle === void 0 ? void 0 : raffle.winners) > ganadoresFinal.length && !ganadoresFinal.some(s => s == miembroRandom)) {
    ...
    const embReroll = new discord_js_1.EmbedBuilder()
        ...
        .setDescription(`Se ha vuelto a seleccionar ${(raffle === null || raffle === void 0 ? void 0 : raffle.winners) == 1 ? "el ganador " : "los ganadores"} del sorteo que esta en ${(channel === null || channel === void 0 ? void 0 : channel.id) == int.channelId ? `este canal` : `el canal <#${channel === null || channel === void 0 ? void 0 : channel.id}>`}.`)
        .setColor("#00ff00");
